# Awesome D [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 475,255 | 🐛 81 | 📅 2026-06-02 with stars

A curated list of awesome D frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 302,642 | 🐛 18 | 🌐 Python | 📅 2026-06-12.

Most documents and links are collected from the [D forum](https://forum.dlang.org), the [D wiki](https://wiki.dlang.org), and the [D package repository](https://code.dlang.org). Exploring GitHub is also helpful, as many libraries are hosted there. If you know of an interesting D project, please let us know via [GitHub issues](https://github.com/dlang-community/awesome-d/issues) ⭐ 754 | 🐛 3 | 🌐 D | 📅 2026-05-02 or by [editing this file](https://github.com/dlang-community/awesome-d/edit/master/README.md) ⭐ 754 | 🐛 3 | 🌐 D | 📅 2026-05-02.
...
* [D Template Tutorial](https://github.com/PhilippeSigaud/D-templates-tutorial) ⭐ 234 | 🐛 11 | 🌐 HTML | 📅 2021-09-21 - A tutorial dedicated to D Templates. Very good explanation about templates. Has pdf version. by Philippe Sigaud.
...
* [dub](https://github.com/dlang/dub) ⭐ 726 | 🐛 531 | 🌐 D | 📅 2026-05-31 - Official package and build management system for D.

## Compilers

*Official compilers for the D language.*

* [DMD](https://github.com/dlang/dmd) ⭐ 3,283 | 🐛 3,813 | 🌐 D | 📅 2026-06-13 - The reference compiler for the D programming language. Stable, builds insanely fast, very good for learning and rapid prototyping/development. Currently the frontend is implemented in D, and shared between dmd, ldc and gdc, the backend is implemented in C++.
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,342 | 🐛 590 | 🌐 D | 📅 2026-06-13 - The LLVM-based D compiler. Uses the DMD frontend and LLVM backend. Builds slower than dmd, but generates more optimized code than DMD. It supports all the target platforms of LLVM.
...
* [SDC](https://github.com/snazzy-d/SDC) ⭐ 270 | 🐛 95 | 🌐 D | 📅 2026-03-16 - The Snazzy D Compiler. Written in D. Grows Smarter every day.
...
* [D-Scanner](https://github.com/dlang-community/D-Scanner) ⭐ 255 | 🐛 129 | 🌐 D | 📅 2026-02-18 - Swiss-army knife for D source code (linting, static analysis, D code parsing, etc.)
* [dfmt](https://github.com/dlang-community/dfmt) ⭐ 215 | 🐛 105 | 🌐 D | 📅 2026-05-30 - formatter for D source code

## Build Tools

*Manage projects and compile software from source code.*

* [dub](https://github.com/dlang/dub) ⭐ 726 | 🐛 531 | 🌐 D | 📅 2026-05-31 - De facto official package and build management system for D. Will be included officially soon.
* [reggae](https://github.com/atilaneves/reggae) ⭐ 188 | 🐛 32 | 🌐 D | 📅 2026-06-12 - meta build system in D
* [cmake-d](https://github.com/dcarp/cmake-d) ⭐ 65 | 🐛 4 | 🌐 CMake | 📅 2023-06-09 - CMake D Projects
...
* [DCD](https://github.com/dlang-community/DCD) ⭐ 360 | 🐛 64 | 🌐 D | 📅 2025-12-26 - Independent auto-complete program for the D programming language. Could be used with editors like vim, emacs, sublime text, textadept, and zeus. See [editors support](https://github.com/dlang-community/DCD/wiki/IDEs-and-Editors-with-DCD-support) ⭐ 360 | 🐛 64 | 🌐 D | 📅 2025-12-26.
* [Visual D](https://github.com/dlang/visuald) ⭐ 305 | 🐛 44 | 🌐 D | 📅 2026-04-27 - Visual Studio extension for the D programming language.
* [serve-d](https://github.com/Pure-D/serve-d) ⭐ 263 | 🐛 156 | 🌐 D | 📅 2026-05-02 - Language Server Protocol (LSP) implementation for D. Adds modern IDE features to any editor with LSP support (VSCode, Atom, Vim/Neovim and others)
...
* [Pegged](https://github.com/dlang-community/Pegged) ⭐ 547 | 🐛 67 | 🌐 D | 📅 2025-07-31 - A Parsing Expression Grammar (PEG) module written in D.
* [libdparse](https://github.com/dlang-community/libdparse) ⭐ 123 | 🐛 27 | 🌐 D | 📅 2026-05-10 - A D language lexer and parser, (possibly) future standard D parser/lexer.
...
* [dub-upgrade](https://github.com/WebFreak001/dub-upgrade) ⭐ 1 | 🐛 2 | 🌐 JavaScript | 📅 2026-05-18 - Run `dub upgrade` trying to repeat on network failure and using package cache on GitHub Actions

## Testing Frameworks

* [unit-threaded](https://github.com/atilaneves/unit-threaded) ⭐ 121 | 🐛 4 | 🌐 D | 📅 2026-05-28 - Multi-threaded unit test framework
* [fluent-asserts](https://github.com/gedaiu/fluent-asserts) ⭐ 48 | 🐛 0 | 🌐 D | 📅 2026-03-12 - Fluent assertion framework with expressive syntax and detailed error messages.
...
* [dlib.container](https://github.com/gecko0307/dlib) ⭐ 224 | 🐛 4 | 🌐 D | 📅 2026-04-20 - generic data structures (GC-free dynamic and associative arrays and more)
...
* [NuMem](https://github.com/Inochi2D/numem) ⭐ 34 | 🐛 0 | 🌐 D | 📅 2026-06-11 - No-GC memory management utilities for DLang.
* [Joka](https://github.com/Kapendev/joka) ⭐ 25 | 🐛 0 | 🌐 D | 📅 2026-06-07 - A nogc utility library.
* [NuLib](https://github.com/Inochi2D/nulib) ⭐ 10 | 🐛 0 | 🌐 D | 📅 2026-06-12 - D "standard" library built ontop of numem.
...
* [serverino](https://github.com/trikko/serverino) ⭐ 77 | 🐛 1 | 🌐 D | 📅 2026-05-21 - Small and ready-to-go http server, in D
...
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 - Adam D. Ruppe's web framework.
...
* [cerealed](https://github.com/atilaneves/cerealed) ⭐ 92 | 🐛 5 | 🌐 D | 📅 2026-05-14 - Serialisation library for D
...
* arsd [dom.d](https://github.com/adamdruppe/arsd/blob/master/dom.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 - an xml/html DOM based on what Javascript provides in browsers
...
* [vibe.d](https://github.com/vibe-d/vibe.d) ⭐ 1,208 | 🐛 442 | 🌐 D | 📅 2026-06-11 - Vibe.d has internal support for Redis and MongoDB, which are very stable. Soon, the database drivers will be separated into independent projects.
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 - Adam D. Ruppe's library; in addition to a Web backend, it also has support for database access with database.d, sqlite.d, mysql.d and postgres.d.
...
* [terminal.d](https://github.com/adamdruppe/arsd/blob/master/terminal.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 - Part of Adam Ruppe's [arsd](https://github.com/adamdruppe/arsd) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 library supporting cursor and color manipulation on the console.
* [scriptlike](https://github.com/Abscissa/scriptlike) ⭐ 92 | 🐛 16 | 🌐 D | 📅 2021-03-10 - Utility library to aid writing script-like programs in D.
...
* [onedrive](https://github.com/abraunegg/onedrive) ⭐ 12,524 | 🐛 11 | 🌐 D | 📅 2026-06-13 - #1 Free OneDrive Client for Linux.
...
* [Soulfind](https://github.com/soulfind-dev/soulfind) ⭐ 42 | 🐛 12 | 🌐 D | 📅 2026-06-09 - Soulseek server implementation in D.
* [todod](https://github.com/BlackEdder/todod) ⭐ 17 | 🐛 2 | 🌐 D | 📅 2017-03-22 - Todod is a command line based todo list manager. It also has support for shell interaction based on [linenoise](https://github.com/antirez/linenoise) ⭐ 4,297 | 🐛 153 | 🌐 C | 📅 2026-05-02.

## GUI Libraries

*Libraries for working with graphical user interface applications.*

* [DLangUI](https://github.com/buggins/dlangui) ⭐ 862 | 🐛 99 | 🌐 D | 📅 2026-04-05 - Cross Platform GUI for D programming language. My personal favorite, because it is written in D(not a binding), and is cross platform. DLangUI also has a good showcase in the IDE [DLangIDE](https://github.com/buggins/dlangide) ⭐ 490 | 🐛 126 | 🌐 D | 📅 2024-03-12.
* [minigui](https://arsd-official.dpldocs.info/arsd.minigui.html) - A smallish GUI widget library, aiming to be on par with at least HTML4 forms and a few other expected gui components. It's part of the [arsd libraries](https://github.com/adamdruppe/arsd/blob/master/minigui.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07.
...
* [giD](https://github.com/Kymorphia/gid) ⭐ 37 | 🐛 4 | 🌐 D | 📅 2026-06-10 - GObject Introspection D Package Repository.
...
* [tilix](https://github.com/gnunn1/tilix) ⭐ 5,685 | 🐛 450 | 🌐 D | 📅 2026-03-25 - A tiling terminal emulator for Linux using GTK+ 3.
* [Inochi Creator](https://github.com/Inochi2D/inochi-creator) ⭐ 1,153 | 🐛 137 | 🌐 D | 📅 2025-06-16 - Inochi2D Rigging Application.
* [Inochi Session](https://github.com/Inochi2D/inochi-session) ⭐ 388 | 🐛 25 | 🌐 D | 📅 2025-11-08 - Application that allows streaming with Inochi2D puppets.
...
* [raylib-d](https://github.com/schveiguy/raylib-d) ⭐ 91 | 🐛 10 | 🌐 D | 📅 2026-04-27 - D bindings for raylib.
...
* [sokol-d](https://github.com/floooh/sokol-d) ⭐ 27 | 🐛 2 | 🌐 C | 📅 2026-06-11 - D bindings for the sokol headers.
* [BindBC](https://github.com/BindBC) - Bindings compatible with `-betterC` and `@nogc`, using [bindbc-loader](https://github.com/BindBC/bindbc-loader) ⭐ 27 | 🐛 0 | 🌐 D | 📅 2025-01-28.
  * [SDL 2](https://github.com/BindBC/bindbc-sdl) ⭐ 129 | 🐛 3 | 🌐 D | 📅 2026-06-01 - Multimedia library
...
* [HipremeEngine](https://github.com/MrcSnm/HipremeEngine) ⭐ 140 | 🐛 4 | 🌐 D | 📅 2026-06-12 - Cross Platform D-Lang Game Engine with scripting support.
* [PixelPerfectEngine](https://github.com/ZILtoid1991/pixelperfectengine) ⚠️ Archived - 2D graphics engine written in D.
* [Parin](https://github.com/Kapendev/parin) ⭐ 74 | 🐛 1 | 🌐 D | 📅 2026-06-07 - A delightfully simple 2D game engine.
...
* [Dagon](https://github.com/gecko0307/dagon) ⭐ 396 | 🐛 9 | 🌐 D | 📅 2026-06-12 - 3D game engine for D. See: <https://gecko0307.github.io/dagon/>
...
* [color.d](https://github.com/adamdruppe/arsd/blob/master/color.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 + [bmp.d](https://github.com/adamdruppe/arsd/blob/master/bmp.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07, [jpg.d](https://github.com/adamdruppe/arsd/blob/master/jpg.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07, [png.d](https://github.com/adamdruppe/arsd/blob/master/png.d) ⭐ 555 | 🐛 54 | 🌐 D | 📅 2026-06-07 - basic color struct, HSL functions and reading and writing image files
...
* [DCompute](https://github.com/libmir/dcompute) ⭐ 143 | 🐛 23 | 🌐 D | 📅 2026-05-15 - [GPGPU with Native D for OpenCL and CUDA](https://dlang.org/blog/2017/07/17/dcompute-gpgpu-with-native-d-for-opencl-and-cuda/)
...
* [mir](https://github.com/libmir/mir) ⭐ 210 | 🐛 0 | 🌐 D | 📅 2022-06-05 - Sandbox for some mir packages: sparse tensors, Hoffman and others.
* [mir-algorithm](https://github.com/libmir/mir) ⭐ 210 | 🐛 0 | 🌐 D | 📅 2022-06-05 - N-dimensional arrays (matrixes, tensors), algorithms, general purpose library.
...
* [sdlang](https://github.com/dlang-community/SDLang-D) ⭐ 121 | 🐛 34 | 🌐 D | 📅 2023-04-30 - An SDL (Simple Declarative Language) library for D.
...
* [Botan](https://github.com/etcimon/botan) ⭐ 91 | 🐛 6 | 🌐 D | 📅 2025-12-20 - Block & stream ciphers, public key crypto, hashing, KDF, MAC, PKCS, TLS, ASN.1, BER/DER, etc.
...
* [hunt](https://github.com/huntlabs/hunt) ⭐ 97 | 🐛 15 | 🌐 D | 📅 2024-01-17 - A refined core library for D programming language. The module has concurrency / collection / event / io / logging / text / serialize and more.
...
* [LibUI](https://github.com/Extrawurst/DerelictLibui) ⭐ 33 | 🐛 4 | 🌐 D | 📅 2021-05-28 - Dynamic Binding for [libui](https://github.com/andlabs/libui) ⭐ 10,882 | 🐛 249 | 🌐 C | 📅 2024-05-29
