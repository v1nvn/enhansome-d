# Awesome D [![Awesome](https://cdn.jsdelivr.net/gh/sindresorhus/awesome@d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,283 | 🐛 83 | 📅 2026-06-02 with stars

A curated list of awesome D frameworks, libraries and software. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 301,524 | 🐛 21 | 🌐 Python | 📅 2026-06-05.

Most documents and links are collected from the [D forum](https://forum.dlang.org), the [D wiki](https://wiki.dlang.org), and the [D package repository](https://code.dlang.org). Exploring GitHub is also helpful, as many libraries are hosted there. If you know of an interesting D project, please let us know via [GitHub issues](https://github.com/dlang-community/awesome-d/issues) ⭐ 753 | 🐛 3 | 🌐 D | 📅 2026-05-02 or by [editing this file](https://github.com/dlang-community/awesome-d/edit/master/README.md) ⭐ 753 | 🐛 3 | 🌐 D | 📅 2026-05-02.
...
* [dub](https://github.com/dlang/dub) ⭐ 724 | 🐛 530 | 🌐 D | 📅 2026-05-31 - Official package and build management system for D.

## Compilers

*Official compilers for the D language.*

* [DMD](https://github.com/dlang/dmd) ⭐ 3,280 | 🐛 3,807 | 🌐 D | 📅 2026-06-05 - The reference compiler for the D programming language. Stable, builds insanely fast, very good for learning and rapid prototyping/development. Currently the frontend is implemented in D, and shared between dmd, ldc and gdc, the backend is implemented in C++.
* [LDC](https://github.com/ldc-developers/ldc) ⭐ 1,340 | 🐛 584 | 🌐 D | 📅 2026-05-24 - The LLVM-based D compiler. Uses the DMD frontend and LLVM backend. Builds slower than dmd, but generates more optimized code than DMD. It supports all the target platforms of LLVM.
...
* [dfmt](https://github.com/dlang-community/dfmt) ⭐ 214 | 🐛 103 | 🌐 D | 📅 2026-05-30 - formatter for D source code

## Build Tools

*Manage projects and compile software from source code.*

* [dub](https://github.com/dlang/dub) ⭐ 724 | 🐛 530 | 🌐 D | 📅 2026-05-31 - De facto official package and build management system for D. Will be included officially soon.
...
* [NuMem](https://github.com/Inochi2D/numem) ⭐ 34 | 🐛 0 | 🌐 D | 📅 2026-06-05 - No-GC memory management utilities for DLang.
* [Joka](https://github.com/Kapendev/joka) ⭐ 26 | 🐛 0 | 🌐 D | 📅 2026-06-04 - A nogc utility library.
* [NuLib](https://github.com/Inochi2D/nulib) ⭐ 10 | 🐛 0 | 🌐 D | 📅 2026-06-01 - D "standard" library built ontop of numem.
...
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 - Adam D. Ruppe's web framework.
...
* arsd [dom.d](https://github.com/adamdruppe/arsd/blob/master/dom.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 - an xml/html DOM based on what Javascript provides in browsers
...
* [vibe.d](https://github.com/vibe-d/vibe.d) ⭐ 1,205 | 🐛 449 | 🌐 D | 📅 2026-05-30 - Vibe.d has internal support for Redis and MongoDB, which are very stable. Soon, the database drivers will be separated into independent projects.
* [arsd](https://github.com/adamdruppe/arsd) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 - Adam D. Ruppe's library; in addition to a Web backend, it also has support for database access with database.d, sqlite.d, mysql.d and postgres.d.
...
* [terminal.d](https://github.com/adamdruppe/arsd/blob/master/terminal.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 - Part of Adam Ruppe's [arsd](https://github.com/adamdruppe/arsd) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 library supporting cursor and color manipulation on the console.
...
* [onedrive](https://github.com/abraunegg/onedrive) ⭐ 12,499 | 🐛 16 | 🌐 D | 📅 2026-06-06 - #1 Free OneDrive Client for Linux.
...
* [minigui](https://arsd-official.dpldocs.info/arsd.minigui.html) - A smallish GUI widget library, aiming to be on par with at least HTML4 forms and a few other expected gui components. It's part of the [arsd libraries](https://github.com/adamdruppe/arsd/blob/master/minigui.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29.
...
* [tilix](https://github.com/gnunn1/tilix) ⭐ 5,686 | 🐛 449 | 🌐 D | 📅 2026-03-25 - A tiling terminal emulator for Linux using GTK+ 3.
* [Inochi Creator](https://github.com/Inochi2D/inochi-creator) ⭐ 1,149 | 🐛 137 | 🌐 D | 📅 2025-06-16 - Inochi2D Rigging Application.
...
* [Parin](https://github.com/Kapendev/parin) ⭐ 72 | 🐛 1 | 🌐 D | 📅 2026-06-04 - A delightfully simple 2D game engine.
...
* [Dagon](https://github.com/gecko0307/dagon) ⭐ 394 | 🐛 9 | 🌐 D | 📅 2026-06-05 - 3D game engine for D. See: <https://gecko0307.github.io/dagon/>
...
* [color.d](https://github.com/adamdruppe/arsd/blob/master/color.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 + [bmp.d](https://github.com/adamdruppe/arsd/blob/master/bmp.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29, [jpg.d](https://github.com/adamdruppe/arsd/blob/master/jpg.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29, [png.d](https://github.com/adamdruppe/arsd/blob/master/png.d) ⭐ 553 | 🐛 54 | 🌐 D | 📅 2026-05-29 - basic color struct, HSL functions and reading and writing image files
